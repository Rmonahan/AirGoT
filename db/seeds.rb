...
Spot.create!([{lat: 40.7829, lng: -73.9654, address: "123 Kingsroad",city: "Winterfell", state: "Westeros", zipcode: 10001, title: "Beatiful home on the outskirts of Winterfell.", description: "This home was built by the early Targarians when the MadKing was still ruling. Our family has resided here for 100's of years. Located right on Kingsroad where you are sure to meet some interesting characters.", allegiance: "Starks", danger_rating: 4.67, house_type: "Colonial", max_occupants: 5, price: 139, number_of_bedrooms: 3, number_of_beds: 4, number_of_bathrooms: 2, square_foot: 4000, host_id: user2.id},
              ...
              {lat: 40.235603,lng: -73.884931, address: "128 Prince's Pass",city: "Dorne", state: "Westeros", zipcode: 10001, title: "Located in the beautiful city of Dorne. Warm weather here all year round!", description: "This location is right in the main city of Dorne. Enjoy the breathtaking architecture and colonial feel of one of the first inhabited places on all of Westeros.", allegiance: "Martell", danger_rating: 8.34, house_type: "Colonial", max_occupants: 6, price: 274, number_of_bedrooms: 5, number_of_beds: 6, number_of_bathrooms: 2, square_foot: 4400, host_id: user5.id},
              {lat: 40.635603,lng: -73.964931, address: "223 Searoad",city: "Casterly Rock", state: "Westeros", zipcode: 10001, title: "Located right near the gold mine of Casterly Rock.", description: "This spot is located next to Casterly Rock which is Lannisters main point of income. Occasionally the Lannisters come by and give out luxerius items and great food. You could get lucky and see it for yourself on your stay!", allegiance: "Lannisters", danger_rating: 3.45, house_type: "Colonial", max_occupants: 4, price: 324, number_of_bedrooms: 3, number_of_beds: 4, number_of_bathrooms: 1, square_foot: 3100, host_id: user4.id},
...
image16 = open('https://s3.amazonaws.com/airgot-dev/images/house4.jpeg')
...
image41 = open('https://s3.amazonaws.com/airgot-dev/images/house9.jpeg')
